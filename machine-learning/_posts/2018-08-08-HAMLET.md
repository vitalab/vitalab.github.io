...
#### Qualitative assessment on PRISMA test data
 ...
 own method. On source of error is high variability in the ground truth
 data which causes their output to have low confidence causing the
 thresholding to cut away parts of the bundle volume in such regions.
