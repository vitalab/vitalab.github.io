...
with 
$$\psi(a,s)=\frac{\nabla_{\pi_{\theta}}(a|s)}{\pi_\theta(a|s)}$$ the score function of the policy 
$$rho(s,a)=\frac{\pi_\theta(a|s)}{q(a|s)}$$a the importance sampling coefficient.
