...
![Figure 3 — Comparison of Method and Open Track submissions: dataset sizes, input dimensionality (2D vs. 3D), SSL objective category, encoder size, backbone architecture, and number of GPUs.](/article/images/fomo/figure3.jpg)
