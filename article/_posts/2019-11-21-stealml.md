...
The authors suggest some countermeasures to such attacks, such as rounding off the prediction's accuracy. The results of round the accuracy (or only providing class labels are reported below)
