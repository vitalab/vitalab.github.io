...
- Volume of training data can possibly compensate for lower accuracy of the labeling.
- The large variety prennent in very large training set could potentially improve the classifier’s ability to generalize to new unseen location.
...
- If low-accuracy, large-scale training data helps, it may allow to substitute a large portion of the manually annotated high-quality data.
...
they make some pre-training befor the real training to get better results.
...
<img src="/deep-learning/images/FCN_OSm/other_5.png" width="300"> [^fn2]
